 ...
 */
#define CONFIG_MACHINE arm-spmp
#define CONFIG_PROFILE 
#define CONFIG_LOADER_TEXT 0x24010000
#define CONFIG_KERNEL_TEXT 0x24100000
#define CONFIG_SYSPAGE_BASE 0x24000000
#define CONFIG_BOOTIMG_BASE 0x24012000
