...
/* Define to 0 if NLS is requested.  */
#define ENABLE_NLS 0

/* Define as 0 if you have catgets and don't want to use GNU gettext.  */
/* #undef HAVE_CATGETS */

/* Define as 0 if you have gettext and don't want to use GNU gettext.  */
...
/* Define to 0 if your utime() takes struct utimbuf as second argument */
/* #define HAVE_STRUCT_UTIMBUF 0 */

/* Define to 0 if ANSI function prototypes are usable.  */
#define PROTOTYPES 0

/* Define to LOG_xxx (a syslog facility) if syslog() shall be used */
/* #define ENABLE_SYSLOG LOG_UUCP */

/* Define to 0 if syslogging shall be forced */
/* #undef ENABLE_SYSLOG_FORCE */

/* Define to 0 if syslogging shall be default */
/* #define ENABLE_SYSLOG_DEFAULT 0 */

/* Define to 0 if lrz shall create directories if needed */
#define ENABLE_MKDIR 0

/* Define to public writable directory if you want this. Leave out the "'s */
/* #undef PUBDIR */

/* Define to 0 if you want support for the timesync protocol */
#define ENABLE_TIMESYNC 0

/* define to 0. we have a replacement function for it. */
#define HAVE_STRERROR 0

/* define to 0 if you want strict ANSI prototypes. will remove some 
...
/* #define HAVE___ARGZ_COUNT 0 */

/* /\* Define if you have the __argz_next function.  *\/ */
/* #define HAVE___ARGZ_NEXT 0 */

/* /\* Define if you have the __argz_stringify function.  *\/ */
/* #define HAVE___ARGZ_STRINGIFY 0 */
